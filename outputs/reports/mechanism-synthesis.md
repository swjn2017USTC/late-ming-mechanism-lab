...
- **Counterexample.** arrears 254 to 26,488 tael with 53 month(s) of decline, against 303,221 assessed - the replicate ends with the largest stock in the arm and still records dozens of months in which it falls. Any reading that needs the stock to be monotone is false in this model.
